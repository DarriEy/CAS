...
from cas.core.exceptions import CASError, ConnectorError
from cas.core.models import QualityFlag
...
def test_suite_contract_metadata() -> None:
    ...
    assert contract["interval_semantics"] == "request_dependent"
    ...
    assert contract["quality_scope"] == "attribute_results_only"
...
def test_suite_connector_error_contract() -> None:
    ...
    assert isinstance(error, CASError)
