...
"""Copernicus DEM GLO-30 connector — global 30m elevation via STAC + COG."""
...
@register("copernicus_dem")
class CopernicusDEMConnector(STACMixin, BaseConnector):
    slug = "copernicus_dem"
    ...
    async def list_datasets(self) -> list[Dataset]:
        return [
            Dataset(
                ...
                description="Global 30m digital elevation model from Copernicus",
                ...
                license="Open",
                citation="Copernicus DEM GLO-30, European Space Agency",
            )
        ]
