...
"""Copernicus DEM GLO-90 connector — global 90m elevation via STAC + COG."""
...
@register("cop_dem_90")
class CopDEM90Connector(STACMixin, BaseConnector):
    slug = "cop_dem_90"
    display_name = "Copernicus DEM GLO-90"
    base_url = STAC_URL
    protocol = "stac_cog"
    ...
    async def list_datasets(self) -> list[Dataset]:
        return [
            Dataset(
                ...
                provider=self.slug,
                name="Copernicus DEM GLO-90 Elevation",
                description="Global 90m digital elevation model from Copernicus",
                ...
                license="Open",
                citation="Copernicus DEM GLO-90, European Space Agency",
            )
        ]
