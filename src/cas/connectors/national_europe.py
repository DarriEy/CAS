...
from cas.connectors.national_europe_ireland import (
    IrelandAquiferConnector as IrelandAquiferConnector,
)
from cas.connectors.national_europe_ireland import (
    IrelandBedrockConnector as IrelandBedrockConnector,
)
from cas.connectors.national_europe_ireland import (
    IrelandCatchmentsConnector as IrelandCatchmentsConnector,
)
from cas.connectors.national_europe_ireland import (
    IrelandFloodConnector as IrelandFloodConnector,
)
from cas.connectors.national_europe_ireland import (
    IrelandGravelAquiferConnector as IrelandGravelAquiferConnector,
)
from cas.connectors.national_europe_ireland import (
    IrelandGroundwaterConnector as IrelandGroundwaterConnector,
)
from cas.connectors.national_europe_ireland import (
    IrelandGWVulnerabilityConnector as IrelandGWVulnerabilityConnector,
)
from cas.connectors.national_europe_ireland import (
    IrelandPeatlandConnector as IrelandPeatlandConnector,
)
from cas.connectors.national_europe_ireland import (
    IrelandSoilWetDryConnector as IrelandSoilWetDryConnector,
)
from cas.connectors.national_europe_ireland import (
    IrelandSubsoilConnector as IrelandSubsoilConnector,
)
from cas.connectors.national_europe_norway import NorwayDEMConnector as NorwayDEMConnector
